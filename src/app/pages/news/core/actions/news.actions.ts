...
export class NewsLoadCollectionSuccessAction implements Action {
    ...
    constructor(public payload: NTypes.INewsList) {
    }
}
...
export type TNewsActions = NewsLoadCollectionAction
    | NewsLoadCollectionSuccessAction
    | NewsLoadCollectionFailAction;
