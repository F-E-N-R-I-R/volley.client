...
@Component({
    selector: 'events-edit-modal',
    templateUrl: 'events-edit-modal.component.html',
    styleUrls: ['events-edit-modal.component.scss']
})

export class EventsEditModalComponent implements OnDestroy {
